========================================================================
    KONSOLENANWENDUNG: ADS Aufgabe 3.3-Projektübersicht
========================================================================

Diese ADS Aufgabe 3.3-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre ADS Aufgabe 3.3-Anwendung besteht.


ADS Aufgabe 3.3.vcxproj
...
ADS Aufgabe 3.3.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen ADS Aufgabe 3.3.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
